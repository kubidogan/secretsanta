...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference("Gift.count") do
      post gifts_url, params: { gift: { description: @gift.description, name: @gift.name, price: @gift.price } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { description: @gift.description, name: @gift.name, price: @gift.price } }
