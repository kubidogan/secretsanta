...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { description: @party.description, event_date: @party.event_date, location: @party.location, title: @party.title, user_id: @party.user_id } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { description: @party.description, event_date: @party.event_date, location: @party.location, title: @party.title, user_id: @party.user_id } }
